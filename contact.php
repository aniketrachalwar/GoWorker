...
<section style="background: linear-gradient(135deg, var(--primary) 0%, var(--primary-hover) 100%); color: var(--white); padding: 80px 0; text-align: center;">
  <div class="container">
    <h1 style="color: var(--white); font-size: 38px; margin-bottom: 12px;">Contact GoWorker Support</h1>
    <p style="color: rgba(255,255,255,0.85); font-size: 16px; max-width: 600px; margin: 0 auto;">Have questions about bookings, payouts, or partner onboarding? We are here to help.</p>
  </div>
</section>
...
<main class="container" style="margin-top: 60px;">
  <div style="display: grid; grid-template-columns: 1fr 1.2fr; gap: 40px; align-items: start;">
    ...
    <section class="card" style="padding: 40px; border-radius: var(--radius-lg); border: 1px solid var(--border-color); background: var(--white); box-shadow: var(--shadow-sm);">
      <h2 style="font-size: 24px; font-weight: 700; margin-bottom: 24px;">Direct Connection</h2>
      ...
      <div style="display: flex; gap: 16px; margin-bottom: 24px; align-items: start;">
        ...
        <div>
          <h4 style="font-size: 15px; font-weight: 600; margin-bottom: 4px;">Phone Call Support</h4>
      ...
      <div style="display: flex; gap: 16px; margin-bottom: 24px; align-items: start;">
        ...
        <div>
          <h4 style="font-size: 15px; font-weight: 600; margin-bottom: 4px;">Email Desk</h4>
      ...
      <div style="display: flex; gap: 16px; align-items: start;">
        ...
        <div>
          <h4 style="font-size: 15px; font-weight: 600; margin-bottom: 4px;">Head Office</h4>
    ...
    <section class="card" style="padding: 40px; border-radius: var(--radius-lg); border: 1px solid var(--border-color); background: var(--white); box-shadow: var(--shadow-sm);">
      <h2 style="font-size: 24px; font-weight: 700; margin-bottom: 24px;">Send Message</h2>
      <form action="#" method="POST" onsubmit="event.preventDefault(); alert('Message sent successfully! Our customer support desk will reach back to you shortly.'); this.reset();">
        <div class="form-group" style="margin-bottom: 20px;">
          ...
          <input type="text" class="form-input" style="padding-left: 16px;" placeholder="Enter your full name" required>
        </div>

        <div class="form-group" style="margin-bottom: 20px;">
          <label style="display: block; font-weight: 600; margin-bottom: 8px; font-size: 14px;">Email Address</label>
          <input type="email" class="form-input" style="padding-left: 16px;" placeholder="you@example.com" required>
        </div>

        <div class="form-group" style="margin-bottom: 24px;">
          <label style="display: block; font-weight: 600; margin-bottom: 8px; font-size: 14px;">Your Message</label>
